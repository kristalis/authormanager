...
@section('content')
 ...
 <div class="form-group row">
          ...
          <div class="about-descr">
            <p class="p-heading">SIGN UP TO GABS BFF PAD</p> 
          </div>
        </div>
                         </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10 offset-md-1">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="Enter your email"  value="{{ old('email') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('schoolname') ? ' has-error' : '' }} row">
                            ...
                            <div class="col-md-10 offset-md-1">
                                <input id="schoolname" type="text" class="form-control" name="schoolname" value="{{ old('schoolname') }}" placeholder="Enter your school"  required autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-10 offset-md-1">
                                <button type="submit" class="btn-block btn-primary btn-medium">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
        ...
        <div class="col-lg-5">
          <div class="about-descr">
           ...
           <p> <a href="{{ route('login') }}" class="btn-block btn-theme btn-medium">Login</a></p>
